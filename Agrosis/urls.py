...
urlpatterns = [
    ...
    #FINANZAS
    path('api/genera', include(router_Genera.urls)),
    path('api/produccion', include(router_produccion.urls)),
    path('api/ventas', include(router_venta.urls)),

    #TRAZABILIDAD
    path('api/actividades', include(router_actividad.urls)),
    path('api/cultivo', include(router_cultivo.urls)),
    path('api/tipo_residuo', include(router_tipo_residuos.urls)),
    path('api/control_fitosanitario', include(router_control_fitosanitario.urls)),
    path('api/desarrollan', include(router_desarrollan.urls)),
    path('api/plantacion', include(router_plantacion.urls)),
    path('api/pea', include(router_pea.urls)),
    path('api/residuos', include(router_residuos.urls)),
    path('api/asignacion', include(routerAsignacion_actividades.urls)),
    path('api/calendario_lunar', include(routerCalendario_lunar.urls)),
    ...
    #INVENTARIO
    path('api/control_usa', include(router_usa.urls)),
    path('api/herramientas', include(router_herramientas.urls)),
    path('api/insumos', include(router_insumo.urls)),
    path('api/requiere', include(router_requiere.urls)),
    path('api/utiliza', include(router_utiliza.urls)),
]
